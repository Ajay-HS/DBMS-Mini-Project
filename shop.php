                    ...
                    <div class="header-right">
                        <ul class="list-unstyled list-inline">
                            <li class="dropdown dropdown-small">
                                <a data-toggle="dropdown" data-hover="dropdown" class="dropdown-toggle" href="#"><span class="key">currency :</span><span class="value">Rs </span><b class="caret"></b></a>
            ...
            <div class="row">
                ...
                <div class="navbar-collapse collapse">
                    <ul class="nav navbar-nav">
                        ...
                        <li class="active">
                            <a href="shop.html"  data-toggle="dropdown">Shop page<span class="caret"></span></a>
                            <ul class="dropdown-menu">
                                <li><a href="##">By stock</a></li>
                                <li><a href="##">Press the new time</a></li>
                             </ul>
                        </li>
